...
const ProductItem: React.FC<{ 
...
}> = ({ product, index, onFindPrice, onProductNameChange, onProductQuantityChange, onMarketPriceChange, onOpenPriceSearch }) => {
    const { t } = useSettings();
    ...
    }, [product.foundMarketPrice, index, product.name]);
                ...
                <div className="space-y-3 flex flex-col justify-center">
                    {(keySpecs.length > 0 || searchQueryPreview) && (
                     ...
                     <div className="p-3 bg-surface rounded-lg border border-border">
                        ...
                        {product.isLoadingMarketPrice ? (
                        ...
                        ) : (product.foundMarketPrice !== undefined && product.foundMarketPrice >= 0) ? (
                            // Log for debugging
                            (console.log(`Rendering price for product ${index}:`, product.foundMarketPrice), true) && 
                            ...
                            // Log for debugging
                            (console.log(`Not rendering price for product ${index}, foundMarketPrice:`, product.foundMarketPrice), true) && 
